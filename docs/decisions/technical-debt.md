...
| **DT-17** | Versão **nunca incrementada**; sem tags | Débito técnico | `Cargo.toml` permanece em `0.1.0` desde o primeiro commit | Não há como referenciar uma versão | Rollback e relatório sem ponto de retorno | Média | Adotar SemVer e criar tags |
